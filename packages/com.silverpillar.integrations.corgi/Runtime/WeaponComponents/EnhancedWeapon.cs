...
namespace MoreMountains.CorgiEngine
{
    ...
    public class EnhancedWeapon : MMMonoBehaviour
    {
        ...
        public EnhancedCharacterHandleWeapon CharacterHandleWeapon { get; set; }
        ...
        protected EnhancedComboWeapon _comboWeapon;
        ...
        public virtual void Initialization()
        {
            if (!_initialized)
            {
                ...
                _comboWeapon = this.gameObject.GetComponent<EnhancedComboWeapon>();
        ...
        public virtual void SetOwner(Character newOwner, EnhancedCharacterHandleWeapon handleWeapon)
        {
            Owner = newOwner;
            if (Owner != null)
            {
        ...
        protected virtual void UpdateAnimator(Animator animator, HashSet<int> list)
        {
            ...
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _idleAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponIdle), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _startAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponStart), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _delayBeforeUseAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBeforeUse), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _useAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBeforeUse || WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponUse || WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBetweenUses), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _singleUseAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponUse), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _delayBetweenUsesAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBetweenUses), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _inCooldownAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponInCooldown), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _stopAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponStop), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _reloadStartAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponReloadStart), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _reloadAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponReload), list);
            MMAnimatorExtensions.UpdateAnimatorBool(animator, _reloadStopAnimationParameter, (WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponReloadStop), list);
