...
namespace SilverPillar.Integrations.Corgi
{
    ...
    public class EnhancedCharacterHandleWeapon : CharacterAbility
    {
        ...
        public EnhancedWeapon InitialWeapon;
        ...
        public EnhancedWeapon CurrentWeapon;
        ...
        protected virtual void HandleWeaponStop()
        {
            ...
            if (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponStop)
            {
        ...
        protected override void HandleInput()
        {
            ...
            if (ContinuousPress && (CurrentWeapon.TriggerMode == EnhancedWeapon.TriggerModes.Auto) && buttonPressed)
            {
                ShootStart();
            }
            ...
            if (CurrentWeapon != null)
            {
                if ((CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBetweenUses)
        ...
        protected virtual void HandleBuffer()
        {
            ...
            if (_buffering && (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponIdle))
            {
        ...
        public virtual void ShootStart()
        {
            ...
            if (BufferInput && (CurrentWeapon.WeaponState.CurrentState != EnhancedWeapon.WeaponStates.WeaponIdle))
            {
        ...
        public virtual void ShootStop()
        {
            ...
            if (!CanShootFromLadders && _movement.CurrentState == CharacterStates.MovementStates.LadderClimbing && CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponIdle)
            {
                return;
            }

            if ((CurrentWeapon.WeaponState.CurrentState    == EnhancedWeapon.WeaponStates.WeaponReload)
                || (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponReloadStart)
                || (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponReloadStop)
                || (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponUse)
                || (CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponInCooldown))
            {
                return;
            }

            if ((CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBeforeUse) && (!CurrentWeapon.DelayBeforeUseReleaseInterruption))
            {
                return;
            }

            if ((CurrentWeapon.WeaponState.CurrentState == EnhancedWeapon.WeaponStates.WeaponDelayBetweenUses) && (!CurrentWeapon.TimeBetweenUsesReleaseInterruption))
            {
                return;
            }
        ...
        public virtual void ChangeWeapon(EnhancedWeapon newWeapon, string weaponID, bool combo = false)
        {
            ...
            if (newWeapon != null)
            {
                if (!combo)
                {
                    CurrentWeapon = (EnhancedWeapon)Instantiate(newWeapon, WeaponAttachment.transform.position + newWeapon.WeaponAttachmentOffset, Quaternion.identity, WeaponAttachment.transform);
                }
