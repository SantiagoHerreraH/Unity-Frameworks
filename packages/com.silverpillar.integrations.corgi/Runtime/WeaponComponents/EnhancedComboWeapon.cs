...
namespace SilverPillar.Integrations.Corgi
{
    ...
    public class EnhancedComboWeapon : CorgiMonoBehaviour
    {
        ...
        public EnhancedWeapon[] Weapons;
        /// the reference to the weapon's Owner
        [MMReadOnly]
        [Tooltip("the reference to the weapon's Owner")]
        public EnhancedCharacterHandleWeapon OwnerCharacterHandleWeapon;
        ...
        public bool ComboInProgress
        {
            get
            {
                ...
                foreach (EnhancedWeapon weapon in Weapons)
                {
                    if (weapon.WeaponState.CurrentState != EnhancedWeapon.WeaponStates.WeaponIdle)
                    {
        ...
        {
            Weapons = GetComponents<EnhancedWeapon>();
        ...
        public virtual void WeaponStarted(EnhancedWeapon weaponThatStarted)
        {
            _countdownActive = false;
        }
        ...
        public virtual void WeaponStopped(EnhancedWeapon weaponThatStopped)
        {
